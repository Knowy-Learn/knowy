...
/**
 * Use case for retrieving a {@link LessonInfo} by its ID.
 * <p>
...
public class GetLessonBaseByIdUserCase {
	 ...
	 * @return the {@link LessonInfo} with the given ID
	 ...
	 */
	public LessonInfo execute(int lessonId) throws KnowyDataAccessException {
