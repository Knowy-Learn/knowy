...
public interface DataLoader {
	 ...
	 * @throws KnowyInvalidDataException if the data does not conform to the schema
	 * @throws IOException               if an I/O error occurs while reading the input stream
	 */
	Map<String, Object> loadData(InputStream inputStream, URL schema) throws KnowyInvalidDataException, IOException;
}